...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "DanceHours@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "DanceHours API";

        private String description = "DanceHours API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "DanceHours";
