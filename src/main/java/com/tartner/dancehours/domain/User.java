...
public class User extends AbstractAuditingEntity implements Serializable {
    ...
    public Set<PersistentToken> getPersistentTokens() { return persistentTokens; }
    public void setPersistentTokens(Set<PersistentToken> persistentTokens) { this.persistentTokens = persistentTokens; }
